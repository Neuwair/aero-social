...
import { getFollowersCount } from "../utils/database.js";
...
export const handler = async (event, context) => {
  ...
  try {
    const cnt = await getFollowersCount(user.uid);
    return respond(200, { success: true, count: cnt });
  } catch (e) {
    console.error("api-getFollowersCount error:", e && e.stack ? e.stack : e);
    return respond(500, {
      success: false,
